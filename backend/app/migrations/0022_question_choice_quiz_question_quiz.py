# Generated by Django 5.0.7 on 2024-09-15 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='quiz', to='app.course')),
            ],
        ),
        migrations.AddField(
            model_name='question',
